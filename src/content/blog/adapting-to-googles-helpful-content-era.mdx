...
tags:
  - SEO Strategies
import { default as featuredImage } from '../../../assets/images/blog/adapting-to-googles-helpful-content-era.webp'
image: 
  src: featuredImage
  alt: "abstract 3d illustration with abstract light scattering on it"
seo:
  image:
    src: '../../assets/images/blog/adapting-to-googles-helpful-content-era.webp'
    alt: abstract 3d illustration with abstract light scattering on it
---
import { Image } from 'astro:assets';
import coverImage from '../../assets/images/blog/adapting-to-googles-helpful-content-era.webp';
