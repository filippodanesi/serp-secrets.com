...
import coverImage from '../../assets/images/blog/seo-the-rise-of-search-everywhere-optimization.webp';
import trafficReferrersImage from '../../assets/images/blog/web-traffic-referrers-2024.webp';
import holisticSeoImage from '../../assets/images/blog/holistic-seo-approach.webp';
import searchPlatformsImage from '../../assets/images/blog/search-platforms-effectiveness.svg';
...
<figure>
  <Image 
    id="article-img" 
    src={trafficReferrersImage} 
    alt="Pie chart showing the Web's largest traffic referrers in January 2024" 
  />
  <figcaption>
    "Who Sends Traffic on the Web and How Much? New Research from Datos & SparkToro" \ Source: <a href="https://sparktoro.com/blog/who-sends-traffic-on-the-web-and-how-much-new-research-from-datos-sparktoro/" target="_blank">SparkToro</a>, by Rand Fishkin
  </figcaption>
</figure>
...
<figure>
  <Image 
    id="article-img" 
    src={holisticSeoImage} 
    alt="Circle diagram showing three main components of Holistic SEO: On-Page SEO in blue focusing on site quality, Off-Site SEO in purple establishing site authority, and Technical SEO in pink focusing on site health" 
  />
  <figcaption>
    "Holistic SEO: How To Improve Your Website" \ Source: <a href="https://www.incrementors.com/blog/holistic-seo-to-improve-your-website/" target="_blank">Incrementors</a>, by Shiv Gupta
  </figcaption>
</figure>
...
<figure>
  <Image 
    id="article-img" 
    src={searchPlatformsImage} 
    alt="Bar chart showing effectiveness percentages across different search platforms including Google, TikTok, Instagram, YouTube, Voice Search and Amazon" 
  />
  <figcaption>
