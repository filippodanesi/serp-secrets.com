...
import coverImage from '../../assets/images/blog/why-user-generated-content-is-key-for-seo-success.webp';
import serpVolatilityImage from '../../assets/images/blog/SERP-Volatility-All-categories-US.png.webp';
import eeatImage from '../../assets/images/blog/E-E-A-T-Content-Creator-Perspective.webp';
...
<figure>
  <Image 
    id="article-img" 
    src={serpVolatilityImage} 
    alt="A graph showing SERP volatility across all categories in the US during Google updates" 
  />
...
<figure>
  <Image 
    id="article-img" 
    src={eeatImage} 
    alt="EEAT guidelines for quality raters experience, expertise, authority and trust" 
  />
