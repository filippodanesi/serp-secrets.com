...
import coverImage from '../../assets/images/blog/keywords-in-seo-why-they-still-matter.webp';
import timelineImage from '../../assets/images/blog/keyword-evolution-timeline-2025.svg';
import distributionImage from '../../assets/images/blog/serp-click-distribution-2025.svg';
...
<LazyTweet 
  url="https://twitter.com/ahrefs/status/1623456789012345678" 
  theme="light"
  caption="Ahrefs shares insights on keyword research in 2025" 
/>
...
<figure>
  <Image id="article-img" src={timelineImage} alt="Timeline showing the evolution of keyword strategy from density focus to semantic search" />
  <figcaption>
...
<LazyTweet 
  url="https://twitter.com/johnmueller/status/1534567890123456789" 
  theme="dark"
  align="left"
  caption="John Mueller on entity recognition in modern search" 
/>
...
<figure>
  <Image id="article-img" src={distributionImage} alt="Bar chart showing click distribution in search results with first position receiving 28.5% of clicks" />
  <figcaption>
    Distribution of clicks across search results positions \ Source: <a href="https://www.searchenginejournal.com/why-keywords-still-matter/425671/" target="_blank">Search Engine Journal</a>, by Winston Burton
  </figcaption>
</figure>
...
<LazyTweet 
  url="https://twitter.com/semrush/status/1645678901234567890" 
  theme="light"
  align="center"
  hideThread={true}
  caption="Semrush explains the connection between intent and keywords" 
/>
...
<LazyTweet 
  url="https://twitter.com/randfish/status/1756789012345678901" 
  theme="dark"
  align="right"
  caption="Rand Fishkin on the power of long-tail keywords" 
/>
...
<LazyTweet 
  url="https://twitter.com/dannysullivan/status/1867890123456789012" 
  theme="light"
  hideThread={true}
/>
