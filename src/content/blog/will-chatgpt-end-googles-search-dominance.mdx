...
import coverImage from '../../assets/images/blog/will-chatgpt-end-googles-search-dominance.webp';

<figure>
  <Image 
    id="cover-img" 
    src={coverImage} 
    alt="A close-up of a cell phone with a blurry background illustrating the competition between ChatGPT and Google" 
    loading="eager" 
    priority={true} 
  />
